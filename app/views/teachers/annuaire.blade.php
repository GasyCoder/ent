...
@section('title') {{ Lang::get($path.'.teachers') }} {{ Lang::get($path.'.annuaire') }} @stop
...
<div class="panel-body">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">{{ Lang::get($path.'.teachers') }} {{ Lang::get($path.'.annuaire') }}</li>
  </ol>
...
{{ Form::open(['route'=>'t_annuaire_teachers', 'method'=>'GET', 'class'=>'col-md-8 col-md-offset-2', 'id'=>'myForm', 'data-toggle'=>'validator'])  }}
...
<a href="{{ URL::route('t_annuaire_teachers') }}" class="btn btn-sm btn-default"> <i class="fa fa-reply-all"></i></a>
...
@foreach($teachers as $teacher)
          ...
          <tr class="tr-body">
            ...
            @endif
              ...
              <td><a class="" href="{{ URL::route('teacher_p_teacher', $teacher->id) }}"><b>{{ $teacher->grade }}.</b> {{ $teacher->fullname }} </a></td>
