...
<div class="clear"></div> <hr>      
          ...
          <div class="col-md-6">
            ...
            {{ Form::open(['route'=>'teacher_update_profile', 'files'=>'true', 'id'=>'myForm', 'data-toggle'=>'validator'])  }}     
...
<option value="{{$user->etat_civil}}" selected="selected" style="color: red;">{{$user->etat_civil}}</option>
@else
...
@endif
            ...
            <div class="col-md-6">
              ...
              {{ Form::open(['route'=>'teacher_update_password', 'files'=>'true', 'id'=>'myForm', 'data-toggle'=>'validator'])  }} 
