...
<div class="panel panel-default panel-main">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ URL::route('admin_managers') }}">{{ Lang::get($path.'.managers') }}</a></li>
...
<?php 
    if (!empty($user->image)) {
      echo HTML::image('uploads/profiles/managers/'.$user->image.'', '', ['width'=>'150px', 'height'=>'150px', 'class'=>'img-circle']);
    } else {
       echo HTML::image('uploads/profiles/manager.png', '', ['width'=>'150px', 'height'=>'150px', 'class'=>'img-circle']);
    }

?>
      </div>

{{ Form::open(['route'=>['update_password_manager', $user->id], 'files'=>'true', 'id'=>'myForm', 'data-toggle'=>'validator'])  }}   
...
{{ Form::open(['route'=>['update_manager', $user->id], 'files'=>'true', 'id'=>'myForm', 'data-toggle'=>'validator'])  }}     
