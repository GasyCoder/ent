    ...
    startDate: '-3d'
        ...
        <div class="col-md-6">
             <div class="form-group">
                ...
                {{ Form::text('date_start', '', ['placeholder'=>'', 'class'=>'form-control input-lg datepicker', 'data-provide'=>'datepicker', 'data-date-format'=>'yyyy-mm-dd']) }} 
                </div>
      ...
      <div class="col-md-6">
             <div class="form-group">
                ...
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                {{ Form::text('date_end', '', ['placeholder'=>'', 'class'=>'form-control input-lg datepicker2', 'data-provide'=>'datepicker', 'data-date-format'=>'yyyy-mm-dd']) }} 
                </div>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div>
              </div>
              ...
              <div class="form-group">
                ...
                <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                  <select name="hour_start" class="form-control input-lg">
                    ...
                    <?php $hours = DB::table('emploi_hours')->get(); ?>
