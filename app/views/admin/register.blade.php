...
if (isset($_GET['matricule_t'])) {
  ...
  $code_matricule_t = htmlspecialchars($_GET['matricule_t']);
...
<hr>
  <div class="col-md-12"><div class="alert alert-info center alert-dismissible" role="alert">
   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    {{ Form::open(['route'=>'teacher_register_store', 'files'=>'false', 'id'=>'register', 'data-toggle'=>'validator'])  }}
            ...
            <div class="form-group">
                ...
                <span class="input-group-addon"><i class="fa fa-book"></i></span>
                  <select name="element_c" class="form-control input-lg">
