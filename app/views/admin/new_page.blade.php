...
@section('title') {{ Lang::get($path.'.new_page') }} @stop
...
<div class="panel panel-default panel-main">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">{{ Lang::get($path.'.new_page') }}</li>
  </ol>
  <div class="clear"></div><hr>


        {{ Form::open(['route'=>'page_store', 'files'=>'true', 'class'=>'col-md-10 col-md-offset-1'])  }}
