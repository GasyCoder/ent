...
@section('title') {{ Lang::get($path.'.new_parent') }} @stop
...
<div class="panel panel-default panel-main">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">{{ Lang::get($path.'.new_parent') }}</li>
  </ol>
...
@endif
        ...
        {{ Form::open(['route'=>'store_parent', 'files'=>'true', 'class'=>'col-md-12', 'id'=>'myForm', 'data-toggle'=>'validator'])  }}
      ...
      <div class="col-md-6">
            ...
            <div class="col-md-12">
              {{ Form::submit(Lang::get($path.'.new_parent'), ['class'=>'btn btn-info btn-block input-lg']) }} 
            </div>
