            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="col-md-3 col-lg-3" align="center"> 
                  ...
                  @if($user->is_manager)
                    @if(!empty($user->image))
                    <?php echo HTML::image('uploads/profiles/managers/'.$user->image.'', '', ['class'=>'img-thumbnail img-responsive']) ?>
                    @else
                      {{ HTML::image('uploads/profiles/manager.png', '', ['class'=>'img-thumbnail img-responsive']) }}
                    @endif
                  @endif
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="td_details">@if($user->gender == 1) {{ Lang::get($path.'.male') }} @elseif($user->gender == 2) {{ Lang::get($path.'.female') }} @else - @endif
                        </td>
                      </tr>
                      <tr>
...
<div class="clear"></div> <hr>      
          ...
          <div class="col-md-6">
            ...
            {{ Form::open(['route'=>'manager_update_profile', 'files'=>'true', 'id'=>'myForm', 'data-toggle'=>'validator'])  }}     
            ...
            <div class="col-md-6">
              ...
              {{ Form::open(['route'=>'manager_update_password', 'files'=>'true', 'id'=>'myForm', 'data-toggle'=>'validator'])  }} 
