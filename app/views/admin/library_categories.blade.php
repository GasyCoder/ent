...
<div class="panel panel-default panel-main">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ URL::route('admin_library') }}">{{ Lang::get($path.'.library') }}</a></li>
...
{{ Form::open(['route'=>'library_catg_store', 'class'=>'col-md-12', 'id'=>'myForm', 'data-toggle'=>'validator'])  }}
...
$getCategory = TheCategoryLibrary::find($id);

if ($getCategory !== null) {  ?>


{{ Form::open(['route'=>['library_catg_update',$getCategory->id], 'class'=>'col-md-8 col-md-offset-2', 'id'=>'myForm2', 'data-toggle'=>'validator'])  }}
      ...
      function refresh() {
        ...
        $('#myForm2').submit(function(event) {
          ...
          $('#myForm2 input.btn').hide();
           ...
           $.ajax({
            type: 'POST',
            url: '{{ route("library_catg_update",$getCategory->id) }}',
            data: $(this).serialize(),
...
@foreach($categories as $categorie)
          ...
          <tr class="tr-body">
            ...
            <td><a onclick="return confirm('{{ Lang::get($path.'.delete') }}')" href="{{ URL::route('library_catg_delete', $categorie->id) }}"><i class="glyphicon glyphicon-trash large"></i></a></td>
