...
<div class="panel panel-default panel-main">
  ...
  <ol class="breadcrumb no-print">
    ...
    <li class="active"><a href="{{ URL::route('admin_payments') }}">{{ Lang::get($path.'.payments') }}</a></li>
...
<div class="col-md-12">
    ...
    <div class="table-responsive">
            ...
            <div class="col-xs-12">
                <h2 class="page-header "><!--<i class="fa fa-flag"></i>-->
            ...
            <div class="col-sm-5">
                <address class="">
                    ...
                    <br>
                    <strong class="">{{ $payment->student->fullname }}</a></strong><br> 
