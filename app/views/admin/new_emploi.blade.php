...
<div class="panel panel-default panel-main">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">{{ Lang::get($path.'.new_emploi') }}</li>
...
{{ Form::open(['route'=>'store_emploi_du_temps', 'class'=>'col-md-12', 'id'=>'myForm', 'data-toggle'=>'validator'])  }}
...
<div class="content">
        <div class="col-md-6">
             <div class="form-group">
                ...
                {{ Form::text('date_start', '', ['placeholder'=>'', 'class'=>'form-control input datepicker', 'data-provide'=>'datepicker', 'data-date-format'=>'dd/mm/yyyy']) }} 
                </div>
      ...
      <div class="col-md-6">
             <div class="form-group">
                ...
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                {{ Form::text('date_end', '', ['placeholder'=>'', 'class'=>'form-control input datepicker2', 'data-provide'=>'datepicker', 'data-date-format'=>'dd/mm/yyyy']) }} 
                </div>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div>
              </div>
        ...
        <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  <select name="days" class="form-control input">
                    <option value="">{{ Lang::get($path.'.select') }}</option>
    ...
    <div class="col-md-6">
              <div class="form-group">
                ...
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                  <select name="teacher" class="form-control input">
                    <option value="">{{ Lang::get($path.'.select') }}</option>
      ...
      <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-blackboard"></i></span>
                  <select name="subject_id" class="form-control input">
                    <option value="">{{ Lang::get($path.'.select') }}</option>
...
@if(!empty($emploi->parcours))
<option value="{{ $emploi->parcours }}" selected="selected">{{ $emploi->parcours }}</option>
@else
...
@endif
        ...
        <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-blackboard"></i></span>
                  <select name="salle" class="form-control input">
                    <option value="">{{ Lang::get($path.'.select') }}</option>
...
<script type="text/javascript">
        ...
        $('#myForm').submit(function(event) {
          ...
          $('#myForm input.btn').hide();
           ...
           $.ajax({
            type: 'POST',
            url: '{{ route("store_emploi_du_temps") }}',
            data: $(this).serialize(),
